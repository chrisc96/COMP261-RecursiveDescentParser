...
public class RoboGame extends JFrame {
	...
	private void createMenu() {
		...
		final JMenuItem load1 = new JMenuItem("core.Robot 1");
		final JMenuItem load2 = new JMenuItem("core.Robot 2");
		 ...
		 * start.setEnabled(false); worldComp.start(core.World.INTERPRETER_SIMPLE); }
		 * });
		 * 
		 ...
		 * worldComp.start(core.World.INTERPRETER_INTERMEDIATE); } });
		 * startAdvanced.addActionListener(new ActionListener() {@Override
		 * public void actionPerformed(ActionEvent e) { load1.setEnabled(false);
		 * load2.setEnabled(false); start.setEnabled(false);
		 * worldComp.start(core.World.INTERPRETER_ADVANCED); } });
		 */
	}
